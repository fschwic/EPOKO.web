var E = (function ($) {
    ...
    function component2Object(component){
        ...
        o.percentComplete = $($(component).find("PERCENT-COMPLETE")).text();
        o.dtstart = {};
        o.dtend = {};
        o.due = {};
        o.created = {};
        ...
        o.due.rfc822 = $($(component).find("DUE")[0]).attr('rfc822');
        ...
        o.completed.rfc822 = $($(component).find("COMPLETED")[0]).attr('rfc822');
        o.dtstart.ics = $($(component).find("DTSTART")[0]).text();
        o.dtend.ics = $($(component).find("DTEND")[0]).text();
        o.due.ics = $($(component).find("DUE")[0]).text();
        ...
        o.completed.ics = $($(component).find("COMPLETED")[0]).text();
